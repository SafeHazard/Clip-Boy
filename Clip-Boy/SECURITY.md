...
bash scripts/sign_release_paste.sh  # -> SHA256SUMS.minisig (legacy Ed25519; needs the key)
...
`sign_release_paste.sh` is the only step that touches the private key (kept separate
