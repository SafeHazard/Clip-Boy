...
public:
    // Default-initialized so begin()'s free-before-realloc is safe on the
    // first call (Clip-Boy local patch — see begin() in the .cpp).
    SparkFun_VL53L5CX_IO* VL53L5CX_i2c = nullptr; // I2C driver object
    VL53L5CX_Configuration* Dev = nullptr;        // Sensor condfiguration struct
