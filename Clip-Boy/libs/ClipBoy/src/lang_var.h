...
// --- Active-transmit tool labels: gated to Sn34k-empty so the active
//     strings are absent from the listen-only binary while the PROGMEM
//     symbols (and thus text_table* initializers) stay valid. ---
...
#else
PROGMEM const char text1_50[] = "";
PROGMEM const char text1_51[] = "";
PROGMEM const char text1_52[] = "";
PROGMEM const char text1_53[] = "";
PROGMEM const char text1_54[] = "";
#endif
